  ...
  return (
    <>
      <div className="home__data">
        <h1 className="home__title" style={{fontSize: "1.8rem", fontWeight: "2.5rem"}}>Zaid Aly
        ...
        <h3  className="home__subtitle"> Advocate, Law Student<br />Engineer, Software Developer </h3>
